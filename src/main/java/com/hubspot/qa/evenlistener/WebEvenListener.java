package com.hubspot.qa.evenlistener;
...
public class WebEvenListener implements WebDriverEventListener {
	...
	public void afterGetText(WebElement element, WebDriver driver, String text) {
		System.out.println("after getting text from element" + element.toString() +" and text is: " + text);
	}
